...
def accept_order():
    """
        Принимает:
            JSON со всеми параметрами для сохранения заказа
        Возвращает:
            JSON Ответ со статусом обработки заказа
    """

    # Расчитать каждый выбранный ингредиент по пришедшим данным

    # Сколько раз кормить зависит от возраста
